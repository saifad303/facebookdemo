    ...
    <div className="px-3 bg-white pb-1 my-4 rounded-md">
      <div className="flex items-center justify-between">
        <div className="flex items-start space-x-2 my-3">
          ...
          <div>
            <p className="text-base font-medium">My name</p>
            <a href="#" className="flex items-center">
              <p className="text-sm font-medium text-gray-500">3m . </p>
      ...
      <div className="leading-6 mb-3">
        ...
        <p>
          ...
          accusantium illo ullam, Lorem, ipsum dolor sit amet consectetur
          adipisicing elit. Officiis alias mollitia minima odio vitae accusamus
          aliquam, voluptas eum temporibus quo molestiae rerum ut qui ratione
          at, consectetur autem, vero sint?
        </p>
      </div>
...
export default PersonalPostTwo;
